        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in [animation-delay:0.6s]">
              ...
              team of engineers, data scientists, and YouTube veterans dedicated to building the ultimate toolkit for channel growth. We turn complex
              analytics into actionable insights, so you can focus on what you do best: creating.
            </p>
            <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3 animate-fade-in [animation-delay:0.8s]">
          ...
          <div className="grid grid-cols-2 gap-4 animate-fade-in [animation-delay:1s]">
            ...
            <Skeleton className="aspect-video w-full" />
            <Skeleton className="aspect-video w-full col-span-2" />
          </div>
        </div>
      </div>
    </section>
